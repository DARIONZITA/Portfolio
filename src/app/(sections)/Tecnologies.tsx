...
function Tecno(){
    return(
        <div className=" flex justify-center w-[100vw] to-white from-slate-400 bg-gradient-to-b from-90%">
            <section id="skill" className=' mr-5 text-sm font-mono   pb-40  p-0  h-fit  grid align-middle shadow-inner'>
            <div>
